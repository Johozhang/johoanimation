...
function resetVariables() {
	pageVerticalPosition = 0, canAnimatePlantInformation = !0, canAnimateBuildingInformation = !0, 0 == isFishStillAnimating && (canAnimateFishInformation = !0), 0 == isCrabStillAnimating && (canAnimateCrabInformation = !0), 0 == isTurtleStillAnimating && (canAnimateTurtleInformation = !0), canAnimateRobotInformation = !0, canAnimateSquidInformation = !0, canAnimateAlienInformation = !0, canAnimateNbaInformation = !0, canAnimateSocialContainer = !0, canDrawManyFireworks = !0
}
...
function setRobbyLeftAndRightEdge() {
	var e = 65;
	robbyRightEdge = .5 * (containerDiv.offsetWidth + robbyDiv.offsetWidth) - e, robbyLeftEdge = .5 * (containerDiv.offsetWidth - robbyDiv.offsetWidth) + e
}
...
function moveDownLayerHorizontal() {
	if("horizontal" == layersMovement) {
		for(var e = 0; e < layerHorizontalArray.length; e++) {
			...
			t >= 0 ? (t = 0, layerHorizontalArray[e].style.top = t + "px", clearInterval(shiftDownLayerHorizontalTimer)) : layerHorizontalArray[e].style.top = t + "px", robbyContainerDiv.offsetTop < sea1Div.offsetTop + layerHorizontalArray[layerHorizontalArray.length - 1].offsetTop && (isRobbyBelowSeaLevel = !1)
		}
		positionVerticalLayersBottomToHorizontalLayersBottom()
...
function disableIsRobbyJumpingAndFalling() {
	isRobbyJumping = !1, isRobbyFalling = !1
}
...
function orientRobby() {
	deltaPageVerticalPosition > 0 && (robbyFramesDiv.style.top = "0px", robbyEyesCloseDiv.style.left = "90px"), 0 > deltaPageVerticalPosition && (robbyFramesDiv.style.top = "-200px", robbyEyesCloseDiv.style.left = "55px")
}
...
function nbaBoardsFall() {
	...
	}, 300, function() {}), nbaBoardsCounter += 1, nbaBoardsCounter >= nbaBoardArray.length && (nbaBoardsCounter = 0)
}
...
function animateNbaPlayerRun() {
	nbaPlayerCounter += 1, shiftNbaPlayerFrame(nbaPlayerCounter % 2)
}
...
function bounceBall() {
	$(nbaBallDiv).fadeTo(0, 1), $(nbaBallDiv).stop().animate({
...
function setAllNbaCounter() {
	nbaBoardsCounter = 0, nbaPlayerCounter = 0
}
...
function shiftRobbyFrame() {
	...
	if(1 == isRobbySwimming && 1 == isRobbyBelowSeaLevel ? (robbyStartFrame = robbyStartSwimFrame, robbyStopFrame = robbyStopSwimFrame) : (robbyStartFrame = robbyStartRunFrame, robbyStopFrame = robbyStopRunFrame), robbyFramesDiv.style.left = -1 * robbyOneFrameWidth * (robbyStartFrame + counter) + "px", robbyStartFrame + counter + switcher > robbyStopFrame && (switcher = -1 * switcher), robbyStartFrame + counter + switcher == robbyStartFrame && (pageVerticalPositionWhenAnimateRobby1 = pageVerticalPosition), robbyStartFrame > robbyStartFrame + counter + switcher) {
		if(pageVerticalPositionWhenAnimateRobby2 = pageVerticalPosition, pageVerticalPositionWhenAnimateRobby1 == pageVerticalPositionWhenAnimateRobby2) return clearShiftRobbyFrameTimer(), void("not moving 2" == layersMovement && robbyHandsUp());
		switcher = -1 * switcher
	}
	counter += switcher
}
...
function positionChainBlockAndStringContainer() {
	for(var e = 0; e < chainBlockAndStringContainerArray.length; e++) 0 == e && (canAnimateBossInformation = canAnimateRobotInformation), 1 == e && (canAnimateBossInformation = canAnimateSquidInformation), 2 == e && (canAnimateBossInformation = canAnimateAlienInformation), chainBlockAndStringContainerArray[e].style.left = .5 * experienceTextContainerArray[e].offsetWidth - .5 * chainBlockAndStringContainerArray[e].offsetWidth + "px", 1 == canAnimateBossInformation ? chainBlockAndStringContainerArray[e].style.bottom = .8 * containerDiv.offsetHeight + experienceTextContainerArray[e].offsetHeight + "px" : chainBlockAndStringContainerArray[e].style.bottom = experienceTextContainerDistanceFromFloor + experienceTextContainerArray[e].offsetHeight + "px"
}
...
function positionExperience1Elements() {
	robotDiv.style.left = experience1ContainerDiv.offsetWidth + "px", $(piechartAolTextGraphic1Div).fadeTo(0, 0), $(piechartAolTextGraphic2Div).fadeTo(0, 0)
}

function positionExperience2Elements() {
	squidDiv.style.left = experience2ContainerDiv.offsetWidth + "px", $(piechartIncognitoTextGraphic1Div).fadeTo(0, 0), $(piechartIncognitoTextGraphic2Div).fadeTo(0, 0), $(piechartIncognitoTextAnimation1Div).fadeTo(0, 0), $(piechartIncognitoTextAnimation2Div).fadeTo(0, 0), $(piechartIncognitoTextCode1Div).fadeTo(0, 0), $(piechartIncognitoTextCode2Div).fadeTo(0, 0), "internet explorer" == browserName && browserVersion <= 8 || $(piechartIncognitoFrontDiv).fadeTo(0, 0)
}

function positionExperience3Elements() {
	alienDiv.style.left = experience3ContainerDiv.offsetWidth + "px", $(piechartFoxnewsTextGraphic1Div).fadeTo(0, 0), $(piechartFoxnewsTextGraphic2Div).fadeTo(0, 0), $(piechartFoxnewsTextAnimation1Div).fadeTo(0, 0), $(piechartFoxnewsTextAnimation2Div).fadeTo(0, 0), $(piechartFoxnewsTextCode1Div).fadeTo(0, 0), $(piechartFoxnewsTextCode2Div).fadeTo(0, 0), "internet explorer" == browserName && browserVersion <= 8 || $(piechartFoxnewsFrontDiv).fadeTo(0, 0)
}
...
function animateRobot() {
	$(robotDiv).stop().animate({
		...
		animatePiechartAolText(), animateRobotHands()
	})
}
...
function changeRobotHands() {
	if(changeRobotHandsCounter >= robotHandChildrenLength) changeRobotHandsCounter = 0, clearInterval(spinRobotHandsTimer), setRobotHandsToDefault(), (pageVerticalPosition + .5 * containerDiv.offsetWidth < experience1ContainerDiv.offsetLeft || pageVerticalPosition + .5 * containerDiv.offsetWidth > experience1ContainerDiv.offsetLeft + experience1ContainerDiv.offsetWidth) && clearInterval(animateRobotHandsTimer);
		...
		for(var e = 0; robotHandChildrenLength > e; e++) e == changeRobotHandsCounter ? setRobotHandsToOpaque(e) : setRobotHandsToTransparent(e);
...
function openSquidHands() {
	...
	for(var e = 0; e < squidHandCloseArray.length; e++) squidHandCloseArray[e].style.opacity = 0, squidHandCloseArray[e].style.filter = "alpha(opacity=0)"
}
...
function closeSquidHands() {
	...
	for(var e = 0; e < squidHandCloseArray.length; e++) squidHandCloseArray[e].style.opacity = 1, squidHandCloseArray[e].style.filter = "alpha(opacity=100)"
}
...
function animatePiechartAolTextGraphic() {
	$(piechartAolTextGraphic1Div).stop().animate({
		opacity: 1
	}, 1e3, function() {}), $(piechartAolTextGraphic2Div).stop().animate({
		opacity: 1
	}, 1e3, function() {})
}

function animatePiechartIncognitoText() {
	animatePiechartIncognitoTextCode(), animatePiechartIncognitoTextGraphic(), animatePiechartIncognitoTextAnimation()
}

function animatePiechartIncognitoTextCode() {
	$(piechartIncognitoTextCode1Div).stop().animate({
		opacity: 1
	}, 1e3, function() {}), $(piechartIncognitoTextCode2Div).stop().animate({
		opacity: 1
	}, 1e3, function() {})
}
...
function animatePiechartIncognitoTextGraphic() {
	$(piechartIncognitoTextGraphic1Div).stop().delay(300).animate({
		opacity: 1
	}, 1e3, function() {}), $(piechartIncognitoTextGraphic2Div).stop().delay(300).animate({
		opacity: 1
	}, 1e3, function() {})
}
...
function animatePiechartIncognitoTextAnimation() {
	$(piechartIncognitoTextAnimation1Div).stop().delay(600).animate({
		opacity: 1
	}, 1e3, function() {}), $(piechartIncognitoTextAnimation2Div).stop().delay(600).animate({
		opacity: 1
	}, 1e3, function() {})
}
...
function animatePiechartFoxnewsTextCode() {
	$(piechartFoxnewsTextCode1Div).stop().animate({
		opacity: 1
	}, 1e3, function() {}), $(piechartFoxnewsTextCode2Div).stop().animate({
		opacity: 1
	}, 1e3, function() {})
}
...
function animatePiechartFoxnewsTextAnimation() {
	$(piechartFoxnewsTextAnimation1Div).stop().delay(300).animate({
		opacity: 1
	}, 1e3, function() {}), $(piechartFoxnewsTextAnimation2Div).stop().delay(300).animate({
		opacity: 1
	}, 1e3, function() {})
}
...
function animatePiechartFoxnewsTextGraphic() {
	$(piechartFoxnewsTextGraphic1Div).stop().delay(600).animate({
		opacity: 1
	}, 1e3, function() {}), $(piechartFoxnewsTextGraphic2Div).stop().delay(600).animate({
		opacity: 1
	}, 1e3, function() {})
}
...
function blinkSeaAnimals(e) {
	for(var t = e, i = new Array, n = Math.ceil(5 * Math.random()), a = 0; n > a; a++) {
		var o = Math.floor(Math.random() * e.length);
		i.push(t[o])
	}
	for(var a = 0; a < i.length; a++) $(i[a]).fadeTo(0, 1), $(i[a]).stop().delay(300).animate({
		opacity: 0
	}, 0, function() {})
}
...
function hideContactConfirmationContainer() {
	if(1 == isContactConfirmationContainerVisible) {
		for(var e = 0; e < contactConfirmationContainerArray.length; e++)
			for(var t = $(contactConfirmationContainerArray[e]).children().children().length, i = 0; t > i; i++) $(contactConfirmationContainerArray[e].children[0].children[i]).fadeTo(0, 0);
...
var contentDiv = document.getElementById("content"),
	...
	blinkRobbyEyesTimer, bannersContainerDiv = document.getElementById("banners-container"),
...
var buildingLegArray = new Array,
	...
	animateRobotHandsTimer, spinRobotHandsTimer, changeRobotHandsCounter = 0,
	...
	animateSquidHandsTimer, moveSquidHandsTimer, openAndCloseSquidHandsCounter = 0,
	alienDiv = document.getElementById("alien"),
	animateAlienHandsTimer, alienSteerDiv = document.getElementById("alien-steer"),
	alienSteerAngle = 0,
	alienSteerPreviousAngle, alienSteerAngleLimit = 15,
	alienSteerAngleIncrement = 5,
	canAnimateBossInformation, canAnimateRobotInformation, canAnimateSquidInformation, canAnimateAlienInformation, piechartAolTextGraphic1Div = document.getElementById("piechart-aol-text-graphic-1"),
	...
	bubbleTimer, shiftUpLayerHorizontalDistance, shiftUpLayerHorizontalTimer, shiftDownLayerHorizontalTimer, shiftUpDownLayerHorizontalIncrement = 40,
	shiftUpDownLayerHorizontalInterval = 40,
	seaAnimalSwimDistance = 900,
	blinkSeaAnimalsTimer, skill1ContainerDiv = document.getElementById("skill-1-container"),
	fishArray = new Array,
	fishEyeArray = new Array,
	canAnimateFishInformation, isFishStillAnimating = !1,
	fishAnimateNumber = 0,
...
var skill2ContainerDiv = document.getElementById("skill-2-container"),
	...
	canAnimateCrabInformation, isCrabStillAnimating = !1,
	crabAnimateNumber = 0,
...
var skill3ContainerDiv = document.getElementById("skill-3-container"),
	...
	canAnimateTurtleInformation, isTurtleStillAnimating = !1,
	turtleAnimateNumber = 0,
	numberOfTurtleInEachRowArray = new Array;
numberOfTurtleInEachRowArray.push(5, 3, 1, 5);
var pageVerticalPosition = 0,
	...
	canAnimateNbaInformation, nbaBoardsCounter, nbaBoardsAnimationTimer, nbaPlayerCounter, nbaPlayerTimer, nbaPlayerEyesDiv = document.getElementById("nba-player-eyes"),
	blinkNbaPlayerTimer, contactContainerDiv = document.getElementById("contact-container"),
	socialContainerDiv = document.getElementById("social-container"),
	canAnimateSocialContainer, happyRobbyTimer, isRobbyHappy = !1,
	...
	scrollOrSwipeTextContainerTimer, canAnimateScrollOrSwipeTextContainer = !0,
	...
	cArray = new Array,
	drawFireworkTimer, drawFireworkCounter = 0,
	fireworkRowNumber = 8,
	fireworkColumnNumber = 16,
	fireworkLayerNumber = 0,
	fireworkDotRadius = 5,
	fireworkCenterX, fireworkCenterY, fireworkOneRadiusDistance, fireworkOneRotationAngle, drawOneLayerOfFireworkTimer, canDrawManyFireworks = !0;
...
seaInformationContainerArray.push(skill1ContainerDiv, skill2ContainerDiv, skill3ContainerDiv), setAllNbaCounter();
var canScrollOrSwipe;
disableScrollOrSwipe(), $(window).on("beforeunload", function() {
	$(window).scrollTop(0)
